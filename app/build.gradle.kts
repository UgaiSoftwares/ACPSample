...
dependencies {
    ...
    implementation("com.agentclientprotocol:acp-ktor-client:0.26.0")
    implementation("com.agentclientprotocol:acp-ktor-server:0.26.0")
